...
userRouter.post('/createUser', [
    check('name').isLength({ min: 3, max: 20 }).withMessage('Name should be between 3 and 20 characters'),
...
userRouter.delete('/deleteCardItem',fetchUser,userController.deleteFromCart)
